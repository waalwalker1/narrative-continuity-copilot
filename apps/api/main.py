        ...
        memory_docs.append(
            {
                ...
                "subject_entity_id": (
                    e.participant_entity_ids[0] if e.participant_entity_ids else "timeline_event"
                ),
                "canonical_text": f"{e.title}: {e.summary} (Order: {e.sequence_position})",
                "vector": [],
                "entity_ids": e.participant_entity_ids,
                "aliases": [],
                "temporal_scope": str(e.sequence_position),
                "narrative_scope": "GLOBAL_CANON",
        ...
        memory_docs.append(
            {
                ...
                "entity_ids": [],
                "aliases": [],
                "temporal_scope": w.scope or "GLOBAL",
                "narrative_scope": "GLOBAL_CANON",
        ...
        memory_docs.append(
            {
                ...
                "canonical_text": f"{t.description} (Status: {t.status.value})",
                "vector": [],
                "entity_ids": t.related_entity_ids or [],
                "aliases": [],
                "temporal_scope": "GLOBAL",
                "narrative_scope": "GLOBAL_CANON",
