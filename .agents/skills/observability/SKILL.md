---
name: observability
description: Instrumenting systems with Prometheus metrics and OpenTelemetry trace spans.
---

# Skill: Observability

## Objective
Instrumenting systems with Prometheus metrics and OpenTelemetry trace spans.
